...
const Footer = () => {
  return (
    <div className=' bg-richblack-800 '>
      ...
      {/* section 1 */}
      <div className='flex lg:flex-row gap-8 items-center justify-between w-11/12 max-w-maxContent text-richblack-400 leading-6 mx-auto '>
        <div className='border-b w-[100%] flex flex-col lg:flex-row pb-5 border-richblack-700 mt-14'>
          ...
          <div className=' lg:w-[50%] flex flex-wrap flex-row justify-between lg:border-r lg:border-richblack-700 pl-3 lg:pr-5 gap-3 '>
            <div className='w-[30%] flex flex-col gap-3 lg:w-[30%] mb-7 lg:pl-0'>
                ...
                <h1 className='text-richblack-50 font-semibold test-[16px]'>Company</h1>
      ...
      {/* section 2 */}
      <div className='flex flex-row justify-between items-center w-11/12 max-w-maxContent text-richblack-400 mx-auto pb-14 text-sm mt-7'>
         <div className='flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full'>
            ...
            <div className='text-center'>Made with ❤️ Aditya Yadav © 2023 TechZone</div>
